...
![before claude.md](before-claude-md.png)
---
...
Add your screenshot here.
![claude response](clauderesponseaftercluaude-md.png)
---

#### Screenshot 5 — Claude refusing or warning against adding React because of the "No JavaScript" convention defined in CLAUDE.md

Add your screenshot here.
![claude-reject](ClaudeRejectReactComponent.png)
---
...
Add your screenshot here.
![Claude.md-InGitHub Repo](claudedInGithubRepo.png)
---
